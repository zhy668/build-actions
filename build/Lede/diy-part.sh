...
# 后台IP设置
export Ipv4_ipaddr="192.168.50.50"            # 修改openwrt后台地址(填0为关闭)
export Netmask_netm="255.255.255.0"         # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="OpenWrt-wyattzheng"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
# 旁路由选项
export Gateway_Settings="192.168.50.2"                 # 旁路由设置 IPv4 网关(填入您的网关IP为启用)(填0为不作修改)
export DNS_Settings="192.168.50.2"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
export Broadcast_Ipv4="192.168.50.255"                   # 设置 IPv4 广播(填入您的IP为启用)(填0为不作修改)
...
export Customized_Information="生命不止！折腾不息！——by wyattzheng"  # 个性签名,你想写啥就写啥，(填0为不作修改)
